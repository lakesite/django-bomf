...
def home(request):
    ...
    if 'download' in request.POST:
        ...
        response['Content-Disposition'] = 'attachment; filename="bom_parts_search.csv"'
        fieldnames = [
            'part_number',
            'part_category',
            'part_synopsis',
...
def part_export_bom(request, part_id=None, part_revision_id=None):
    ...
    response = HttpResponse(content_type='text/csv')
    response['Content-Disposition'] = 'attachment; filename="{}_bom_parts_indented.csv"'.format(
...
def part_export_bom_flat(request, part_revision_id):
    ...
    response = HttpResponse(content_type='text/csv')
    response['Content-Disposition'] = 'attachment; filename="{}_bom_parts_flat.csv"'.format(
...
def export_part_list(request):
    ...
    response = HttpResponse(content_type='text/csv')
    response['Content-Disposition'] = 'attachment; filename="bom_parts.csv"'
